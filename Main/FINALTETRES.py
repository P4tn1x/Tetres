import pygame, random, sys, threading, time #importnem pygame, random, sys, threading, time
from pygame import * #z pygame importuje všetko

#Nastaviť klasickú hru tak, že keď sa spustí program, aby tam nebolo fps a difficulty a aby sa to spustalo stlacenim U
...
BG = pygame.image.load("tetres2.jpg") #Pozadie bude obrázok tetres2.jpg
...
def play(): #Hra
    ...
    while not done: #Dokým done nebude True 
        ...
        screen.fill(WHITE) #Pozadie sa dá na bielu
        ...
        if game.state == "gameover":  #Ak je stav hry "gameover"
            ...
            odist = pygame.image.load("esc2.png") #Definujeme obrázok "esc2"
            lrshift = pygame.image.load("shift2.png") #Definujeme obázok "shift2"
            
            screen.blit(kjube, (520,200)) #Vykreslíme obrázok "crackedcube"
            screen.blit(odist, (130,430)) #Vykreslíme obrázok "esc2"
            screen.blit(lrshift, (875,435)) #Vykreslíme obrázok "shift2"
...
def ovladanie(): #Button na ovládanie
    while True: #Keď stlačíme button "KEYBINDS"
        ...
        BG1 = pygame.image.load("patreskoklavesbutbetter.png") #Definujeme obrázok "patreskoklavesbutbetter"
        SCREEN.blit(BG1, (0,0)) #Vykreslíme obrázok "patreskoklavesbutbetter" ako pozadie
